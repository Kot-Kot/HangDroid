...
public class GameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    int mPoints = 0;
   // Button myButtonNextWord = (Button) findViewById(R.id.buttonNextWord);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //myButtonNextWord.setEnabled(false);
        ...
        Button myButtonNextWord = (Button)findViewById(R.id.buttonNextWord);
        myButtonNextWord.setOnClickListener((View.OnClickListener) this);
    ...
    */
    ...
    public void checkLetter(String introducedLetter) {
        ...
        if (mGuessedLetters == mWord.length()) {
            Toast.makeText(this, "Congrats! Go to the next word.", Toast.LENGTH_SHORT).show();
            Button myButtonNextWord = (Button) findViewById(R.id.buttonNextWord);
            myButtonNextWord.setEnabled(true);
            //mPoints++;
           // clearScreen();
            //setRandomWord();
            //createTextViews(mWord);
...
/*
    ...
    */
    ...
    public void setRandomWord() {
        ...
        Log.d("MYLOG", "The Rnumber is " + randomNumber);
    ...
    public void letterFailed(String letterFailed) {
        ...
        //boolean repeatedWrongLetter = false;
        TextView textViewFailed = (TextView) findViewById(R.id.textViewForFailedLetters);
